  ...
  <div>
    <div class="cover-photo relative">
      ...
      >
        <el-button
          :icon="Edit"
          class="edit-cover absolute bottom-4 right-4"
          circle
        />
      </el-tooltip>
    </div>
    <el-row :gutter="24" class="relative flex flex-row h-[100px] justify-between">
      ...
      <el-col :span="4" class="info-avatar ml-60 mt-4">
        ...
        <h2 class="follower text-xl font-medium opacity-50">3 followers</h2>
      </el-col>
      <el-col :span="10" class="flex justify-end content-center">
    <div class="w-full flex justify-end space-x-2">
      <el-button type="primary" icon="Edit">Chỉnh sửa thông tin cá nhân</el-button>
